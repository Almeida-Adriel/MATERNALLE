      ...
      <main className="flex-1 min-h-screen">
        ...
        <section className="bg-brand-50 py-6">
            <div className="max-w-6/8 mx-auto p-6 md:p-10">
                <h3 className="text-3xl font-bold text-brand-800 text-center">Escolha o Plano Ideal para Você</h3>
                <p className="text-center text-slate-600 mt-3 mb-10">Acesso completo a todas as ferramentas de suporte à maternidade.</p>
